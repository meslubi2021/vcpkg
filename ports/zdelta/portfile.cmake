...
vcpkg_from_github(
    ...
    REPO snej/zdelta
    REF 0016ee8f9fdd14135ae29e2cbc42542d87a5d0dc
...
# Put the license where vcpkg expects it
message(STATUS "Packaging license")
file(COPY ${SOURCE_PATH}/zlib-copyright DESTINATION ${CURRENT_PACKAGES_DIR}/share/box2d)
file(RENAME ${CURRENT_PACKAGES_DIR}/share/box2d/zlib-copyright ${CURRENT_PACKAGES_DIR}/share/box2d/copyright)
